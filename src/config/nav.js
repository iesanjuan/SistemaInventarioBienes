// Items de navegación del sidebar. `path: null` = pantalla no disponible
...
export const NAV_ITEMS = [
  ...
  { label: 'Asignaciones', icon: 'assignment_return', path: '/asignaciones' },
  { label: 'Reportes', icon: 'assessment', path: '/reportes' },
]
